...
import { ColorHighlightOverlay } from './color-highlight-overlay';
        ...
        <DialogContent className="max-w-[95vw] max-h-[95vh] p-0 bg-black/95">
          <div className="relative w-full h-[95vh] flex flex-col">
            <MediaViewerHeader
              ...
              showDominantColors={showDominantColors}
              onToggleColorAnalysis={toggleColorAnalysis}
              showColorAnalysis={showColorAnalysis}
            ...
            <ColorHighlightOverlay
              ...
              isVisible={showDominantColors && !!selectedHighlightColor}
            />

            <DominantColors
              imageSrc={images[currentIndex]}
              isVisible={showDominantColors}
              onToggle={toggleDominantColors}
              onColorHighlight={setSelectedHighlightColor}
            />
