          ...
          <div className="container py-6 max-w-4xl">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground text-lg">
                Find answers to common questions about using Lightmark for your photography workflow
              </p>
            </div>
            ...
            <div className="mt-12 text-center p-6 bg-muted rounded-lg">
              ...
              <p className="text-muted-foreground mb-4">Can't find what you're looking for? We're here to help!</p>
